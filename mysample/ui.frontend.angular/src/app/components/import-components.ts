 ...
 */
MapTo('mysample/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('mysample/components/separator')(SeparatorV1Component);

MapTo('mysample/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('mysample/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('mysample/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('mysample/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('mysample/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('mysample/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('mysample/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('mysample/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('mysample/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('mysample/components/accordion')(AccordionV1Component);
MapTo('mysample/components/tabs')(TabsV1Component);
...
LazyMapTo('mysample/components/teaser')(TeaserV1Component);
...
LazyMapTo('mysample/components/carousel')(CarouselV1Component);
...
LazyMapTo('mysample/components/text')(LazyTextModule, TextEditConfig);